...
每个带注释的图像都拥有一个具有相同文件名的注释文件，例如00041000_测试.jpg, 00041000_温度jpg和00041000.txt是测试图像、模板图像和相应的注释文件。测试图像上的每个缺陷都被标注为格式：x1，y1，x2，y2，类型，其中（x1，y1）和（x2，y2）是缺陷边界框的左上角和右下角。类型是匹配项后面的整数ID:0-正常、1-开放、2-短、3-鼠标位、4-短、5-铜、6-针孔。
